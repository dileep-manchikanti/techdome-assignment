...
export class Main extends Component{
    ...
    render(){
        ...
        years.forEach((year)=>{
            ...
            Filters.push(<div className="col-6"><button className="btn btn-primary year" year={year} id={year} style={{backgroundColor:this.state.year===year.valueOf()?"green":"blue"}} onClick={this.updateYear}>{year}</button></div>);
        });
        Filters.push(<div><br></br></div>);
        Filters.push(<h5 className="text-center">Successful Launch</h5>);
        Filters.push(<div className="col-6"><button className="btn btn-primary" id='true' style={{backgroundColor:this.state.launch==='true'?"green":"blue"}} onClick={this.updateLaunch}>True</button></div>);
        Filters.push(<div className="col-6"><button className="btn btn-primary" id='false' style={{backgroundColor:this.state.launch==='false'?"green":"blue"}} onClick={this.updateLaunch}>False</button></div>);
        Filters.push(<div><br></br></div>);
        Filters.push(<h5 className="text-center">Successful Landing</h5>);
        Filters.push(<hr></hr>)
        Filters.push(<div className="col-6"><button className="btn btn-primary" id='true' style={{backgroundColor:this.state.landed==='true'?"green":"blue"}} onClick={this.updateLanding}>True</button></div>);
        Filters.push(<div className="col-6"><button className="btn btn-primary" id='false' style={{backgroundColor:this.state.landed==='false'?"green":"blue"}} onClick={this.updateLanding}>False</button></div>);
        return(
            <div className="main">
                <h1>SpaceXLaunchPrograms</h1>
